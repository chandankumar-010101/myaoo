...
class _ChatInputRowState extends State<ChatInputRow> {
  ...
  ChatListControllerGet chatListControllerGet = Get.put(ChatListControllerGet());
  @override
              ...
              child: AnimatedContainer(
                ...
                child: PopupMenuButton<String>(
                  ...
                  <PopupMenuEntry<String>>[
                    ///share files
                    if (chatListControllerGet.permissions.value!.isShareFiles || userType == 2)
                    ...
                    // ),
                    ///share photo
                    if (chatListControllerGet.permissions.value!.isSharePhoto || userType == 2)
                      PopupMenuItem<String>(
                        enabled: true,
                        value: 'image',
                        child: ListTile(
                    ...
                    if (PlatformInfos.isMobile &&
                        (chatListControllerGet.permissions.value!.isSharePhoto || userType == 2))
                      PopupMenuItem<String>(
                        value: 'camera',
                        child: ListTile(
                          leading: const CircleAvatar(
                    ...
                    ///share video
                    if (PlatformInfos.isMobile &&
                        (chatListControllerGet.permissions.value!.isShareVideo || userType == 2))
                      PopupMenuItem<String>(
                        value: 'camera-video',
                        child: ListTile(
                          leading: const CircleAvatar(
                    ...
                    ///share location
                    if (PlatformInfos.isMobile &&
                        (chatListControllerGet.permissions.value!.isShareLocation ||
                            userType == 2))
                      PopupMenuItem<String>(
                        value: 'location',
                        child: ListTile(
